...
const Page = () => {
  return (
    <main className=" w-full min-h-screen flex flex-col items-center relative z-20 py-32 lg:py-40">
      ...
      <span className="mb-7 text-gray-400 text-xs lg:text-sm">27/08/2024</span>
      ...
      <div className="w-[75%] max-w-96 md:max-w-none md:w-[500px] lg:w-[600px] xl:w-[800px] font-light text-sm xl:text-base text-gray-200 flex flex-col space-y-4">
        <p className=" w-full text-justif">
          &emsp;The website showcases Core Align&apos;s new &quot;Hypfo &quot;
          shoes with an immersive 3D experience and smooth navigation. It
          highlights the shoe&apos;s design, technology, and features, offering
          a modern, responsive interface for users to explore.
        </p>
        <p className=" w-full pb-5">
          &emsp;This is website use framer motion to apply scroll based
          animation to the 3d assets and the background to make it appealing.
        </p>
        <div className="pb-5">
        ...
        <div className="pb-5">
          ...
          <ul className=" list-disc pl-5 lg:pl-7 space-y-2">
            <li>
              <span className="font-semibold ">Scroll Based Animation</span> a
              dynamic and engaging browsing experience as you explore the
              content.
            </li>
          </ul>
        </div>
